...
Deno.test("validateAll", () => {
  const table: [unknown, [boolean, string[]]][] = [
    ...
    [lengthOf(40), [true, []]],
    ["A", [false, [INVALID_LESS_THAN_2, INVALID_SPECIAL_CHAR]]],
...
Deno.test("validateNestLand", () => {
  const table: [unknown, boolean, [boolean, string | string[]]][] = [
    ...
    ["a", false, [false, INVALID_LESS_THAN_2]],
    ["a", true, [false, [INVALID_LESS_THAN_2]]],
    ...
    ["A", false, [false, INVALID_LESS_THAN_2]],
    ["A", true, [false, [INVALID_LESS_THAN_2, INVALID_SPECIAL_CHAR]]],
